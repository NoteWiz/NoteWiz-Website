      ...
      <head>
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-P57L3TL3');
          `}
        </Script>
      </head>
      <body className={`${grotesque.variable} ${dm_sans.className}`}>
        <SessionProvider session={session}>
        
          <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P57L3TL3"
