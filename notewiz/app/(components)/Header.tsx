...
export const Header = () => {
  ...
  return (
    <div className="flex items-center justify-center pt-8 mx-auto ">
      <div className="flex justify-between mx-auto items-center py-[1vw]  bg-[#FFE57D] rounded-3xl fixed mt-16 z-10 md:gap-x-14 gap-x-2 px-3 md:px-4">
        ...
        <button
          className=" bg-black rounded-3xl font-medium text-large text-white  px-[20px] py-3 "
