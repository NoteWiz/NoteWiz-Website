...
const SignInComponent = () => {
	...
	return (
		sessionStatus !== "authenticated" && (
			<div className="flex flex-row h-screen justify-center items-center bg-[#252525]">
				<div className="bg-[#181818] flex flex-row gap-36 rounded-xl">
					<div className="flex  ">
				...
				{loading ? (
					...
					<section className="flex flex-col items-center justify-evenly ">
						<div className=" rounded-lg p-12 md:p-16 lg:p-18 max-h-screen max-w-xl  mx-auto w-[50vw] h-[70vh] lg:h-[94vh]">
							<h3 className="mb-2  font-semibold text-5xl text-white tracking-tighter text-center">
								Welcome Back
							</h3>
