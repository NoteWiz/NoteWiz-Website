      ...
      <section className="flex-grow flex items-center justify-center">
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12 lg:p-16">
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-700 dark:text-gray-400">Don't have an account yet? <Link href="#" className="text-pink-400 hover:underline font-bold">Sign up</Link></p>
          </div>
        </div>
      </section>
    </div>
