  ...
  return (
    <div className="bg-[#131313] min-h-screen text-white pt-5">
      ...
      >
        ...
        <div id="decoration" className="flex flex-row justify-between w-[80%]">
          <Image src={first} alt="" className="relative top-16" />
          <Image src={second} alt="" className="relative top-16 left-10" />
        </div>
        <p className="text-[100px] tracking-tighter font-medium">
          Let's Reimagine Learning
        </p>
        <div className="flex flex-row justify-end w-[80%]">
          <Image src={third} alt="" className="relative right-16" />
        </div>
        <p className="text-[#CCCCCC] text-sm w-1/4 text-center">
          Charge up your learning with AI based tools and kickstart your journey
        </p>
        <Link href="/signup">
          <button className="bg-[#00E340] mt-5 text-black px-8 py-4 rounded-xl font-bold tracking-tighter drop-shadow-md">
            {" "}
            Start Learning Now
          </button>
        </Link>
      ...
      <div id="cards-container" className="mt-36 flex">
        <div id="headings" className="flex flex-col ml-60 w-[68%] mt-5">
          ...
          <div id="cards-row-2" className="py-6 flex flex-row gap-x-5">
            <div className="bg-[#1e1e1e] w-[60%] h-[50vh] rounded-xl">
              <div className="flex flex-row">
                <div className="flex flex-col gap-y-4 tracking-tighter pl-4 pt-20 justify-center">
                  ...
                  <p className=" text-lg">
                    Chat will all your documents. Just upload them in a single
                    click and ask questions right away.
                  </p>
                </div>
            ...
            <div className="bg-[#1e1e1e] w-[40%] h-[50vh] rounded-xl">
              <div className="flex flex-col tracking-tighter justify-center items-center gap-y-2 h-full">
                ...
                <p className="text-3xl font-medium">Lots of practice</p>
                <p className="w-2/3 font-medium text-center">
                  Generate custom questions suited to your needs and start
                  practicing.
                </p>
              </div>
            </div>
          </div>
          <div id="cards-row-2" className="py- flex flex-row-reverse gap-x-5">
            <div className="bg-[#1e1e1e] w-[60%] h-[50vh] rounded-xl">
              <div className="flex flex-row">
                <div className="flex flex-col gap-y-4 tracking-tighter pl-4 pt-20 justify-center">
                  <p className="text-3xl font-medium">
                ...
                <div className="pr-4 flex justify-center pt-8">
                  <Image src={c2} width={600} alt="" className="" />
                </div>
              </div>
            </div>
            <div className="bg-[#1e1e1e] w-[40%] h-[50vh] rounded-xl">
              <div className="flex flex-col tracking-tighter justify-center items-center gap-y-3 h-full">
                <div className="pr-4 flex justify-center ">
                  <Image src={c4} width={290} alt="" className="" />
                </div>
                <p className="text-3xl font-medium">Flashcards in a flash</p>
                <p className="w-2/3 font-medium text-center">
                  Generate flashcards based on a single prompt and never forget
                  any concept.{" "}
                </p>
              </div>
            </div>
      ...
      >
        <div className="flex flex-col justify-center">
          <p className="text-[#00E340] text-sm">Features to look forward to</p>
          <p className="text-white text-4xl tracking-tighter">
            Your personal community
          </p>
          <p className=" py-10 ml-1">
            A collaborative learning environment that allows you to share your
      ...
      >
        <div className="flex flex-col justify-center">
          <p className="text-[#00E340] text-sm">Personalized Feedback</p>
          <p className="text-white text-4xl tracking-tighter ">
            Achieve your goals like never before{" "}
          </p>
          <p className=" py-10 ml-1">
            Monitor your progress and know exactly what steps to take to achieve
            your target. Utilize personalized dashboards, track using our fun
            and easy-to-follow metrics.
          </p>
        </div>
      ...
      <div className="flex flex-col justify-center items-center pt-20 relative">
        ...
        <p className="text-[#00E340] text-sm z-10">Glimpses of Success</p>
        <p className="text-white text-4xl tracking-tighter">
          ...
          <div className="bg-[#1e1e1e] w-[60%] h-[40vh] rounded-xl">
            <div className="flex flex-col">
              ...
              <p className="p-4">
                ...
                condimentum justo ac gravida lobortis. Sed consequat magna nec
                ex scelerisque.
              </p>
            </div>
          </div>
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="flex flex-col justify-center items-center pb-5">
          ...
          <p className="text-5xl text-white w-2/3 text-center tracking-tighter z-10">
            Say Goodbye to Notes and Hello to Notewiz
          </p>
          <Link href="/signup">
            <button className="bg-[#00E340] mt-5 text-black px-10 py-4 rounded-xl font-bold tracking-tighter drop-shadow-md">
              Start Now
            </button>
          </Link>
        </div>
      ...
      <div className="h-[80vh] bg-black w-full rounded-t-[60px]">
        <div className="flex flex-col justify-center items-center">
          ...
          <div id="social-icons" className="flex flex-row gap-x-8 mt-4">
