...
// const QuizFormCreate: React.FC<Props> = (props) => {
//   const [generatedQuestions, setGeneratedQuestions] = useState([]);
//   const [selectedQuestionType, setSelectedQuestionType] = useState("");

//   const [inputType, setInputType] = useState<"text" | "topic" | "file">(props.inputType);

//   const form = useForm<QuizCreationType>({
//     resolver: zodResolver(QuizCreationSchema as any),
//     defaultValues: {
//       type: inputType,
//       text: props.text || "",
//       topic: props.topic || "",
...
//   const onSubmit: SubmitHandler<QuizCreationType> = (data) => {
//     const formData = new FormData();
//     formData.append("type", data.type);
//     formData.append("questionType", data.questionType);
//     formData.append("difficulty", data.difficulty);
