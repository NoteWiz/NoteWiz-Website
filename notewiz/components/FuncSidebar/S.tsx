...
const S = () => {
	...
	return (
		<section className="sticky left-0 top-0 flex h-screen w-fit flex-col bg-[#181818] p-6 pt-2 text-white max-sm:hidden  lg:w-[264px] rounded-tr-xl">
			...
			<div className=" flex flex-col gap-4 ml-1 justify-end">
				<Popover>
					<PopoverTrigger>
					...
					<PopoverContent>
						<div className="flex flex-row gap-2  items-center rounded-lg hover:bg-[#181818] p-3 cursor-pointer"  onClick={() => signOut({ callbackUrl: "/login" })}>
              <LogOut color="white"/>
