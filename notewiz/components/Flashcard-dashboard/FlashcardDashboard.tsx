		...
		<div className="bg-[#252525] min-h-screen">
			<div className="flex max-sm:flex-col max-sm:items-center">
				...
				<div className="w-1/3 m-5 max-sm:w-[300px]  ">
					<div
						id="thirdCard"
						className=" mt-10 w-full max-sm:h-[300px] h-[545px] rounded-2xl bg-[#1e1e1e] hover:-translate-y-[15px] cursor-pointer border-2 border-b-4 border-r-4 border-black transition-all duration-300 hover:border-[#00E340]"
					>
				...
				<div id="Container" className="flex flex-col w-1/3 m-5 max-sm:w-full max-sm:items-center">
					<div
						id="FirstCard"
						className=" mt-10 max-sm:mt-0 w-full h-64 max-sm:h-[300px] max-sm:w-[300px] bg-[#1E1E1E] rounded-2xl hover:-translate-y-[15px] border-2 border-b-4 border-r-4 cursor-pointer border-black transition-all duration-300 hover:border-[#00E340]"
					>
