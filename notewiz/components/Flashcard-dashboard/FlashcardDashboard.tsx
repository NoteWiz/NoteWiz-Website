  ...
  return (
    <div className='flex bg-[#252525]'>
        ...
        <div className='ml-[90px] w-[500px] mt-[72px]'>
            ...
            <div className='third-card h-[630px] w-[500px] mt-[72px] ml-8 rounded-2xl bg-[#1e1e1e] hover:-translate-x-[-15px] cursor-pointer border-2 border-b-4 border-r-4 border-black transition-all duration-300 hover:border-[#00E340]'>
